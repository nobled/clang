...
// RUN: %clang_cc1 -triple i386-apple-darwin10 -plugin analyzer -plugin-arg-analyzer -analyzer-checker=core,experimental.deadcode.IdempotentOperations,experimental.core,osx.cocoa.AtSync -plugin-arg-analyzer -analyzer-store=region -plugin-arg-analyzer -analyzer-constraints=basic -verify -fblocks -Wno-unreachable-code -Wno-null-dereference %s
// RUN: %clang_cc1 -triple i386-apple-darwin10 -plugin analyzer -plugin-arg-analyzer -analyzer-checker=core,experimental.deadcode.IdempotentOperations,experimental.core,osx.cocoa.AtSync -plugin-arg-analyzer -analyzer-store=region -plugin-arg-analyzer -analyzer-constraints=range -verify -fblocks -Wno-unreachable-code -Wno-null-dereference %s
// RUN: %clang_cc1 -triple x86_64-apple-darwin10 -plugin analyzer -plugin-arg-analyzer -analyzer-checker=core,experimental.deadcode.IdempotentOperations,experimental.core,osx.cocoa.AtSync -plugin-arg-analyzer -analyzer-store=region -plugin-arg-analyzer -analyzer-constraints=basic -verify -fblocks -Wno-unreachable-code -Wno-null-dereference %s
// RUN: %clang_cc1 -triple x86_64-apple-darwin10 -plugin analyzer -plugin-arg-analyzer -analyzer-checker=core,experimental.deadcode.IdempotentOperations,experimental.core,osx.cocoa.AtSync -plugin-arg-analyzer -analyzer-store=region -plugin-arg-analyzer -analyzer-constraints=range -verify -fblocks -Wno-unreachable-code -Wno-null-dereference %s
