// RUN: %clang_cc1 -Wno-array-bounds -plugin analyzer -plugin-arg-analyzer -analyzer-checker=core,experimental.unix,experimental.security.ArrayBound -plugin-arg-analyzer -analyzer-store=region -verify %s
// XFAIL: *
