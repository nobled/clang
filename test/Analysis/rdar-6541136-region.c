// RUN: %clang_cc1 -verify -plugin analyzer -plugin-arg-analyzer -analyzer-checker=core,experimental.security.ArrayBound -plugin-arg-analyzer -analyzer-store=region %s
