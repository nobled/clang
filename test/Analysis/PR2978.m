// RUN: %clang_cc1 -plugin analyzer -plugin-arg-analyzer -analyzer-checker=experimental.core -plugin-arg-analyzer -analyzer-checker=experimental.osx.cocoa.Dealloc %s -verify
