// RUN: %clang_cc1 -plugin analyzer -plugin-arg-analyzer -analyzer-checker=core,osx.cocoa.RetainCount,osx.cocoa.NSAutoreleasePool -plugin-arg-analyzer -analyzer-store=region -fobjc-gc-only -fblocks -verify %s
