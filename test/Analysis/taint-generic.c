// RUN: %clang_cc1  -plugin analyzer -plugin-arg-analyzer -analyzer-checker=experimental.security.taint,core,experimental.security.ArrayBoundV2 -Wno-format-security -verify %s
