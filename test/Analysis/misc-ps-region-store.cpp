// RUN: %clang_cc1 -triple i386-apple-darwin9 -plugin analyzer -plugin-arg-analyzer -analyzer-checker=core,experimental.core -plugin-arg-analyzer -analyzer-store=region -verify -fblocks -plugin-arg-analyzer -analyzer-opt-analyze-nested-blocks %s
// RUN: %clang_cc1 -triple x86_64-apple-darwin9 -plugin analyzer -plugin-arg-analyzer -analyzer-checker=core,experimental.core -plugin-arg-analyzer -analyzer-store=region -verify -fblocks   -plugin-arg-analyzer -analyzer-opt-analyze-nested-blocks %s
