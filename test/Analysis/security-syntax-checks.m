// RUN: %clang_cc1 -triple i386-apple-darwin10 -plugin analyzer -plugin-arg-analyzer -analyzer-checker=security.insecureAPI,security.FloatLoopCounter %s -verify
// RUN: %clang_cc1 -triple i386-apple-darwin10 -plugin analyzer -DUSE_BUILTINS -plugin-arg-analyzer -analyzer-checker=security.insecureAPI,security.FloatLoopCounter %s -verify
// RUN: %clang_cc1 -triple i386-apple-darwin10 -plugin analyzer -DVARIANT -plugin-arg-analyzer -analyzer-checker=security.insecureAPI,security.FloatLoopCounter %s -verify
// RUN: %clang_cc1 -triple i386-apple-darwin10 -plugin analyzer -DUSE_BUILTINS -DVARIANT -plugin-arg-analyzer -analyzer-checker=security.insecureAPI,security.FloatLoopCounter %s -verify
