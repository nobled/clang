// RUN: %clang_cc1 -triple i386-apple-darwin9 -plugin analyzer -plugin-arg-analyzer -analyzer-checker=core,experimental.deadcode.IdempotentOperations,experimental.core.CastToStruct,experimental.security.ReturnPtrRange,experimental.security.ArrayBound -plugin-arg-analyzer -analyzer-store=region -verify -fblocks -plugin-arg-analyzer -analyzer-opt-analyze-nested-blocks %s
// RUN: %clang_cc1 -triple x86_64-apple-darwin9 -DTEST_64 -plugin analyzer -plugin-arg-analyzer -analyzer-checker=core,experimental.deadcode.IdempotentOperations,experimental.core.CastToStruct,experimental.security.ReturnPtrRange,experimental.security.ArrayBound -plugin-arg-analyzer -analyzer-store=region -verify -fblocks   -plugin-arg-analyzer -analyzer-opt-analyze-nested-blocks %s
