// RUN: %clang_cc1 -triple x86_64-apple-darwin10 -plugin analyzer -plugin-arg-analyzer -analyzer-checker=core,osx.cocoa.VariadicMethodTypes -plugin-arg-analyzer -analyzer-store=region -fblocks -verify %s
