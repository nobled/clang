// RUN: %clang_cc1 -fcxx-exceptions -fexceptions -plugin analyzer -plugin-arg-analyzer -analyzer-checker=debug.DumpCFG -plugin-arg-analyzer -cfg-add-implicit-dtors %s 2>&1 | FileCheck %s
// XPASS: *
