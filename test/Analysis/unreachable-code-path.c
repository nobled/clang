// RUN: %clang_cc1 -plugin analyzer -plugin-arg-analyzer -analyzer-checker=core,deadcode.DeadStores,experimental.deadcode.UnreachableCode -verify -plugin-arg-analyzer -analyzer-opt-analyze-nested-blocks -Wno-unused-value %s
