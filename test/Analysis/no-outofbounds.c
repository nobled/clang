// RUN: %clang_cc1 -plugin analyzer -plugin-arg-analyzer -analyzer-checker=core,experimental.core,experimental.unix,experimental.security.ArrayBound -plugin-arg-analyzer -analyzer-store=region -verify %s
